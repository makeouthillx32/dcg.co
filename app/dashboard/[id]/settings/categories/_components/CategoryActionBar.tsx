// app/settings/categories/_components/CategoryActionBar.tsx
"use client";
...
export function CategoryActionBar({ search, onSearchChange, onCreate }: Props) {
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      <div className="w-full sm:max-w-sm">
        <CategoriesSearchBar value={search} onChange={onSearchChange} />
      </div>
