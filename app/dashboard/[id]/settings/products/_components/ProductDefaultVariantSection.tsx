    ...
    <div className="rounded-xl border border-[hsl(var(--border))]">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <Package size={16} />
          <span className="text-sm font-semibold">Default Variant (Optional)</span>
        </div>
        ...
        <div className="px-4 pb-4 space-y-3 border-t border-[hsl(var(--border))] pt-3">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Leave blank to inherit product price"
            />
            <p className="text-xs text-[hsl(var(--muted-foreground))]">
              Only set if this variant has a different price than the base product
            </p>
          </div>
        </div>
      )}
