...
// Renders a print-ready shipping slip + packing list.
// Usage: wrap in a hidden div, call window.print() to trigger browser PDF export.
// The @media print CSS hides everything except #dcg-print-slip.

import { AdminOrder } from '@/lib/orders/types';

const STORE_NAME = 'Desert Cowgirl Co.';
const STORE_ADDRESS = [
  // Fill in your actual return address
  'Desert Cowgirl Co.',
...
interface ShippingSlipProps {
  order: AdminOrder;
  // Optional extra packaging weight in oz (box, tissue, etc.)
...
export function ShippingSlip({ order, extraWeightOz = 0 }: ShippingSlipProps) {
  ...
  return (
    <div id="dcg-print-slip" className="bg-white text-black font-sans text-sm print:text-xs">
      {/* ── PAGE 1: SHIPPING LABEL / PACKING SLIP ── */}
      <div className="p-8 max-w-[680px] mx-auto print:p-6 print:max-w-none">
        ...
        {/* Ship To + Package Info side by side */}
